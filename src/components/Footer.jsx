            ...
            <div className="footer-container">
                ...
                <div className="footer-list">
                    <ul id="footer-ul">
                        ...
                        <li className="footer-li"><Link className="footer-link" to="https://portfolio-website-lemon-alpha-46.vercel.app/Skills" target='_blank'>Portfolio <i class="fa-solid fa-briefcase"></i></Link></li>
                    </ul>
                </div>
            </div>
        </footer>
